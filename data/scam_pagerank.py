# Tool that suggests ways to artificially inflate your pagerank
...
def get_clean_data():
    ...
    restricted_pages = data_utils.get_restricted_pages()
    editable_pages = [id for id in backlinks.keys()
                      if id not in restricted_pages]
    return {
...
def inflate_page_rank(data, page_id, amount):
    ...
    # Sort the editable pages by approximately how much page rank they could
    # lend to us
